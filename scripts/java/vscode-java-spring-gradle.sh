...
echo "Installing Java ${JAVA_VERSION}, Maven, Gradle and Spring Boot tools..."
...
echo "Installing Java, Spring Boot and Gradle extensions for code-server..."
...
echo "Spring Boot Java environment with Gradle setup completed."
